...
void applyAffineTransform1(Mat &warpImage, Mat &src, vector<Point2f> &srcTri, vector<Point2f> &dstTri)
{
...
void warpTriangle2(Mat &img1, Mat &img2, vector<Point2f> t1, vector<Point2f> t2)
{
    ...
    applyAffineTransform1(warpImage, img1Rect, t1Rect, t2Rect);
...
int main6( int argc, char** argv)
{
    ...
    for(size_t i = 0; i < numImages; i++)
    {
        ...
        for(size_t j = 0; j < dt.size(); j++)
        {
            ...
            warpTriangle2(imagesNorm[i], img, tin, tout);
        }
