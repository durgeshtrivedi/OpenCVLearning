...
vector<Point2f> readPoints1(string pointsFileName){
...
void warpTriangle1(Mat &img1, Mat &img2, vector<Point2f> &t1, vector<Point2f> &t2)
{
...
{	
	...
	points1 = readPoints1(filename1 + ".txt");
	points2 = readPoints1(filename2 + ".txt");
	...
	for(size_t i = 0; i < dt.size(); i++)
    {
        ...
        warpTriangle1(img1, img1Warped, t1, t2);
