...
void applyAffineTransform2(Mat &warpImage, Mat &src, vector<Point2f> &srcTri, vector<Point2f> &dstTri)
{
...
void morphTriangle1(Mat &img1, Mat &img2, Mat &img, vector<Point2f> &t1, vector<Point2f> &t2, vector<Point2f> &t, double alpha)
{
    ...
    applyAffineTransform2(warpImage1, img1Rect, t1Rect, tRect);
    applyAffineTransform2(warpImage2, img2Rect, t2Rect, tRect);
...
int main7( int argc, char** argv)
{
    ...
    while(ifs >> x >> y >> z)
    {
        ...
        t.push_back( points[x] );return 0; // Durgesh added the line 
        t.push_back( points[y] );
        t.push_back( points[z] );
        
        morphTriangle1(img1, img2, imgMorph, t1, t2, t, alpha);
